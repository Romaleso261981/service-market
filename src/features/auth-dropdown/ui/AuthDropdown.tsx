    ...
    <div className="relative" ref={ref}>
      <button
        ...
        className={cn(
          ...
          open && (isDark ? 'bg-white/10' : 'bg-gray-100')
        )}
        aria-expanded={open}
        aria-haspopup="true"
      ...
      >
        ...
        <svg className={cn('h-4 w-4', isDark ? 'text-white' : 'text-gray-500')} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
